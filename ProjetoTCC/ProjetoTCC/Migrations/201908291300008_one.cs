    ...
    public partial class one : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        TermoLocacao_Id = c.Int(nullable: false),
                        TipoVeiculo_Id = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                ...
                .ForeignKey("dbo.Periodos", t => t.Periodo_Id, cascadeDelete: true)
                .ForeignKey("dbo.TermoLocacoes", t => t.TermoLocacao_Id, cascadeDelete: true)
                .ForeignKey("dbo.TipoVeiculos", t => t.TipoVeiculo_Id, cascadeDelete: true)
